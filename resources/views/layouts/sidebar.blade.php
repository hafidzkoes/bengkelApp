<div x-show="sidebarOpen" style="display: none;" class="fixed inset-0 z-20 transition-opacity bg-black/50 lg:hidden" @click="sidebarOpen = false"></div>

<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="-translate-x-full fixed inset-y-0 left-0 z-30 flex flex-col w-64 h-full overflow-y-auto transition duration-300 transform bg-gray-50 text-gray-800 lg:translate-x-0 lg:static lg:inset-0 shadow-sm border-r border-gray-200">
