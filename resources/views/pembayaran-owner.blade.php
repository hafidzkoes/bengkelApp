                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-5 transition hover:border-blue-200">
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                                ...
                                <label class="inline-flex items-center cursor-pointer group">
                                    <!-- LOGIKA CHECKBOX DIPERBAIKI DENGAN PERIKSA PERMINTAAN DARI FORM DULU -->
                                    <input type="checkbox" name="tampilkan_harga_ban" value="1" 
                                           {{ (old() ? old('tampilkan_harga_ban') : ($workshop->tampilkan_harga_ban ?? true)) ? 'checked' : '' }} 
                            ...
                            <div>
                                ...
                                <div class="relative rounded-xl shadow-sm max-w-md">
                                    ...
                                    <input type="number" name="harga_tambal_ban" value="{{ old('harga_tambal_ban', $workshop->harga_tambal_ban ?? 0) }}" 
                                ...
                                <!-- Tempat memunculkan pesan error -->
                                @error('harga_tambal_ban')
                        ...
                        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-5 transition hover:border-blue-200">
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                                ...
                                <label class="inline-flex items-center cursor-pointer group">
                                    <!-- LOGIKA CHECKBOX DIPERBAIKI DENGAN PERIKSA PERMINTAAN DARI FORM DULU -->
                                    <input type="checkbox" name="tampilkan_harga_mesin" value="1" 
                                           {{ (old() ? old('tampilkan_harga_mesin') : ($workshop->tampilkan_harga_mesin ?? true)) ? 'checked' : '' }} 
                                           class="w-5 h-5 rounded text-blue-600 focus:ring-blue-500 border-gray-300 transition">
                                    <span class="ml-2.5 text-xs font-semibold text-gray-500 group-hover:text-gray-900 transition-colors">Tampilkan di Dashboard</span>
                                </label> 
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative rounded-xl shadow-sm max-w-md">
                                    ...
                                    <input type="number" name="harga_perbaikan_mesin" value="{{ old('harga_perbaikan_mesin', $workshop->harga_perbaikan_mesin ?? 0) }}" 
                                           class="block w-full rounded-xl border-gray-300 pl-12 pr-4 py-3 focus:border-blue-500 focus:ring-blue-500 text-base font-bold text-gray-900" placeholder="0">
                                </div>
                                <!-- Tempat memunculkan pesan error -->
                                @error('harga_perbaikan_mesin')
                                    <p class="text-red-500 text-sm font-semibold mt-1">{{ $message }}</p>
                                @enderror
                            </div>
