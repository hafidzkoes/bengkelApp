<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('workshop.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-red-400 hover:bg-red-50 transition-colors duration-300 bg-gray-50 group relative">
                                    <div class="space-y-2 text-center">
                                        ...
                                        <p class="text-xs text-gray-500 font-medium mt-2">PNG, JPG up to 20MB (Opsional)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 mt-8">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                            <label class="text-base font-bold text-gray-800">
                                Titik Koordinat Bengkel
                            </label>
                            <p class="text-xs text-red-500 font-bold mt-1 sm:mt-0">
                                *Wajib: Geser dan klik pada peta untuk menancapkan pin lokasi.
                            </p>
                        </div>
                        
                        <div id="map" style="height: 450px; z-index: 1;" class="w-full rounded-xl shadow-inner border border-gray-300"></div>
                ...
                <div class="mt-10 pt-6 border-t border-gray-200 flex justify-end">
                    <button type="submit" class="w-full md:w-auto bg-red-600 hover:bg-red-700 text-white px-10 py-3.5 rounded-xl shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 font-extrabold transition-all duration-300 transform hover:-translate-y-0.5">
                        Simpan Perubahan
                    </button>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // --- LOGIKA PENGUNCI NOMOR HP BENGKEL ---
            const kontakInput = document.getElementById('nomor_kontak');
            if (kontakInput) {
